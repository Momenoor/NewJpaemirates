...
{
    public function accept(Request $request, MatterRequest $matterRequest)
    {
    ...
    public function disputeForm(Request $httpRequest, MatterRequest $matterRequest)
    {
        if ($matterRequest->status !== RequestStatus::PENDING) {
            return $this->alreadyUsed($matterRequest);
        }
    ...
    public function disputeSubmit(Request $httpRequest, MatterRequest $matterRequest)
    {
